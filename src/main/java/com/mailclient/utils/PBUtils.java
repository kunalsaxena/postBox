...
public class PBUtils {
    ...
    public static ConfigDTO readConfigObject() throws IOException {
        try {
            ...
            ConfigDTO configDTO = mapper.readValue(new File("/home/kunal/postbox/mailProperties"), ConfigDTO.class);
            return configDTO;
    ...
    public static void writeConfig(ConfigDTO configDTO) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        mapper.writeValue(new File( "/home/kunal/postbox/mailProperties"), configDTO);
    }
